...
import { UploadFilled, Document, Close, CircleCheck, CircleClose, Clock } from '@element-plus/icons-vue'
...
const tipText = computed(() => {
  return `支持任意类型文件，单个文件最大 ${props.maxSize}MB，最多 ${props.limit} 个文件`
})
